...
static float      battv_A = 1200; //Battery warning voltage - units Volt *10 
static float      battv_B = 1200; //Battery warning voltage - units Volt *10 
...
static float        osd_vbat_A = 0.0;                 // Battery A voltage in milivolt
...
//static uint8_t      batt_A_warn_level = 0;
//static uint8_t      batt_B_warn_level = 0;

//static uint8_t    osd_battery_pic_A = 0xb4;       // picture to show battery remaining
static float      osd_vbat_B = 0.0;               // voltage in milivolt
...
byte panBatteryUsed_XY[2][npanels];
...
static float voltage_calibration_B = 1.0;
static float current_calibration_A = 1.0;
